...
function UseContext(){
    ...
    return (
        <div style={{padding: 40}}>
            <button onClick = {contextValue.handleToggle}>Toggle theme</button>
            <p className={contextValue.theme}> 
                <p>
                    React Context:
                ...
                <p>
                    ...
                    To illustrate, we have many nested components. The component at the top 
                    and bottom of the stack need access to the state.
